...
def parse_args():
    ...
    parser.add_argument('--dataset_name', type=str, default='realtimeqa',choices=['realtimeqa-mc','realtimeqa','open_nq','biogen', 'simpleqa', 'triviaqa','realtimeqa_allrel'],help='dataset name')
